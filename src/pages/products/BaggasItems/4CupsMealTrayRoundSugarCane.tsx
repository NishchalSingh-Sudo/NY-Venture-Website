// src/pages/products/BiodegradableItems/FourCupsMealTrayRoundSugarCane.tsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 font-inter">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <h1 className="text-5xl font-bold text-foreground mb-6 font-playfair">
              4 Cups Meal Tray Round - Sugar Cane
            </h1>
            <p className="text-xl text-muted-foreground font-inter">
              Discover our innovative biodegradable 4-cup round meal trays, crafted from sustainable sugar cane, perfect for eco-conscious serving.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          {fourCupsMealTrays.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {fourCupsMealTrays.map((product) => (
                <ProductCard
                  key={product.id}
                  id={product.id}
                  name={product.name}
            ...
            <p className="text-center text-lg text-gray-700">No 4 Cups Meal Tray Round (Sugar Cane) found at the moment. Please check back later!</p>
          )}
        </div>
      </section>
...
export default FourCupsMealTrayRoundSugarCane;