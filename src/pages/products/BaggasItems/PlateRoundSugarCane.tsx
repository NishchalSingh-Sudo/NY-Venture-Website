// src/pages/products/BiodegradableItems/PlateRoundSugarCane.tsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 font-inter">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <h1 className="text-5xl font-bold text-foreground mb-6 font-playfair">
              Round Plates - Sugar Cane
            </h1>
            <p className="text-xl text-muted-foreground font-inter">
              Explore our environmentally friendly round plates, crafted from natural sugar cane bagasse, offering a durable and sustainable alternative for all your dining needs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          {roundSugarCanePlates.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {roundSugarCanePlates.map((product) => (
                <ProductCard
                  key={product.id}
                  id={product.id}
                  name={product.name}
            ...
            <p className="text-center text-lg text-gray-700">No Round Plates (Sugar Cane) found at the moment. Please check back later!</p>
          )}
        </div>
      </section>
...
export default PlateRoundSugarCane;