// // src/pages/products/CopperItems/CopperJarMeenakari.tsx
...
// const CopperJarMeenakari: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperMeenakariJars: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Storage Jars' 
//   ).filter(product => product.name.includes('Meenakari')); // Added name filter for more specificity
...
//               Copper Jars - Meenakari
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our stunning collection of copper jars, hand-painted with exquisite Meenakari designs, bringing tradition and utility to your home.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperMeenakariJars.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperMeenakariJars.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Meenakari Jars found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperJarMeenakari;
