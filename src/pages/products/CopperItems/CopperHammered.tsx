// // src/pages/products/CopperItems/CopperHammered.tsx
...
// const CopperHammered: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperHammeredBottles: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Water Bottles' 
//   ).filter(product => product.name.includes('Hammered')); // Added name filter for more specificity
...
//               Copper Hammered Bottles
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Explore our collection of authentic hammered copper bottles, a blend of traditional craftsmanship and health benefits.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperHammeredBottles.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperHammeredBottles.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Hammered Bottles found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
