// // src/pages/products/CopperItems/CopperPlainHalfHammered.tsx
...
// const CopperPlainHalfHammered: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperPlainHalfHammeredBottles: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Water Bottles' 
//   ).filter(product => product.name.includes('Plain Half Hammered')); // Added name filter for more specificity
...
//               Copper Plain Half Hammered Bottles
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our unique collection of copper bottles with a distinctive plain and half-hammered finish, blending modern style with traditional benefits.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperPlainHalfHammeredBottles.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperPlainHalfHammeredBottles.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Plain Half Hammered Bottles found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperPlainHalfHammered;
