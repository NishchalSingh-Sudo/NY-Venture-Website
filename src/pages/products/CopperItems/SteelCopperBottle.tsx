// // src/pages/products/CopperItems/SteelCopperBottle.tsx
...
// const SteelCopperBottle: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const steelCopperBottles: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Water Bottles' 
//   ).filter(product => product.name.includes('Steel Copper Bottle')); // Added name filter for more specificity
...
//               Explore our innovative collection of steel copper bottles, designed for durability, style, and the wellness benefits of copper.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {steelCopperBottles.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {steelCopperBottles.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Steel Copper Bottles found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default SteelCopperBottle;
