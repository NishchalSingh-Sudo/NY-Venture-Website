// // src/pages/products/CopperItems/CopperMatkaDesign1.tsx
...
// const CopperMatkaDesign1: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperMatkaDesign1Products: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Matkas' 
//   ).filter(product => product.name.includes('Design 1')); // Added name filter for more specificity
...
//               Copper Matkas - Design 1
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our stunning collection of copper matkas with unique designs, combining traditional water storage with contemporary appeal.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperMatkaDesign1Products.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperMatkaDesign1Products.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Matkas (Design 1) found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperMatkaDesign1;
