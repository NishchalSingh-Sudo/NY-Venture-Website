// // src/pages/products/CopperItems/CopperKingBottle.tsx
...
// const CopperKingBottle: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperKingBottles: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Water Bottles' 
//   ).filter(product => product.name.includes('King Bottle')); // Added name filter for more specificity
...
//               Discover the grandeur of our Copper King Bottles, offering ample hydration and a statement of elegance.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperKingBottles.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperKingBottles.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper King Bottles found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperKingBottle;
