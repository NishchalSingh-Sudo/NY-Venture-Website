// // src/pages/products/CopperItems/CopperMatkaAntique.tsx
...
// const CopperMatkaAntique: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperAntiqueMatkas: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Matkas' 
//   ).filter(product => product.name.includes('Antique')); // Added name filter for more specificity
...
//               Copper Matkas - Antique
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our stunning collection of antique copper matkas, perfect for traditional water storage and enhancing your home decor.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperAntiqueMatkas.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperAntiqueMatkas.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Antique Matkas found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperMatkaAntique;
