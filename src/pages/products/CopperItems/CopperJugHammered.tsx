// // src/pages/products/CopperItems/CopperJugHammered.tsx
...
//               Copper Jugs - Hammered
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our timeless collection of hammered copper jugs, handcrafted to perfection for both aesthetic appeal and health benefits.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperHammeredJugs.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperHammeredJugs.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Hammered Jugs found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperJugHammered;
