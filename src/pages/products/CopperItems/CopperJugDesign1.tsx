// // src/pages/products/CopperItems/CopperJugDesign1.tsx
...
// const CopperJugDesign1: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperJugDesign1Products: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Jugs' 
...
//               Copper Jugs - Design 1
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our beautifully crafted copper jugs, perfect for enhancing your dining experience and benefiting from the richness of copper.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperJugDesign1Products.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperJugDesign1Products.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Jugs (Design 1) found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperJugDesign1;
