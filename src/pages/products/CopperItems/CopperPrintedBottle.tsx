// // src/pages/products/CopperItems/CopperPrintedBottle.tsx
...
// const CopperPrintedBottle: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperPrintedBottles: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Water Bottles' 
//   ).filter(product => product.name.includes('Printed Bottle')); // Added name filter for more specificity
...
//               Copper Printed Bottles
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our vibrant collection of copper printed bottles, where traditional health benefits meet contemporary design.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperPrintedBottles.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperPrintedBottles.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Printed Bottles found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperPrintedBottle;
