// // src/pages/products/CopperItems/CopperHalfHammeredColorMatt.tsx
...
// const CopperHalfHammeredColorMatt: React.FC = () => {

//   // Filter products directly from allDetailedProductsData
//   // Using category and subCategory from your allProductsData.ts
//   const copperHalfHammeredColorMattBottles: DetailedProduct[] = allDetailedProductsData.filter(product =>
//     product.category === 'copper-items' && 
//     product.subCategory === 'Copper Water Bottles'
//   ).filter(product => product.name.includes('Half Hammered Color Matt')); // Added name filter for more specificity
...
//               Copper Half Hammered Color Matt Bottles
//             </h1>
//             <p className="text-xl text-muted-foreground font-inter">
//               Discover our contemporary collection of copper bottles featuring unique half-hammered designs and stylish matte finishes.
//             </p>
//           </div>
//         </div>
//       </section>
...
//           {copperHalfHammeredColorMattBottles.length > 0 ? (
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
//               {copperHalfHammeredColorMattBottles.map((product) => (
//                 <ProductCard
//                   key={product.id}
//                   id={product.id}
//                   name={product.name}
...
//             </div>
//           ) : (
//             <p className="text-center text-lg text-gray-700">No Copper Half Hammered Color Matt Bottles found at the moment. Please check back later!</p>
//           )}
//         </div>
//       </section>
...
// export default CopperHalfHammeredColorMatt;
